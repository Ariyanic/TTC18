...
/**
 * @ast node
 * @declaredat C:\\Users\\imenrayan\\Desktop\\EMFeRTTC18-master\\jastadd-mquat-base\\src\\main\\jastadd\\Expression.ast:14
 * @production SubExpression : {@link BinaryExpression};

 */
public class SubExpression extends BinaryExpression implements Cloneable {
  /**
   * @aspect Logging
   * @declaredat C:\\Users\\imenrayan\\Desktop\\EMFeRTTC18-master\\jastadd-mquat-base\\src\\main\\jastadd\\Logging.jadd:52
   */
  protected static final org.apache.logging.log4j.Logger logger = org.apache.logging.log4j.LogManager.getLogger(SubExpression.class);
  /**
   ...
   */
  public SubExpression(Expression p0, Expression p1) {
    setChild(p0, 0);
    setChild(p1, 1);
  }
  /** @apilevel low-level 
   ...
   */
  public SubExpression clone() throws CloneNotSupportedException {
    SubExpression node = (SubExpression) super.clone();
    return node;
  }
  /** @apilevel internal 
  ...
  public SubExpression copy() {
    try {
      SubExpression node = (SubExpression) clone();
      node.parent = null;
      if (children != null) {
   ...
   */
  public SubExpression treeCopyNoTransform() {
    SubExpression tree = (SubExpression) copy();
    if (children != null) {
