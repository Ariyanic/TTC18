...
/**
 * @ast node
 * @declaredat C:\\Users\\imenrayan\\Desktop\\EMFeRTTC18-master\\jastadd-mquat-base\\src\\main\\jastadd\\Expression.ast:10
 * @production ParenthesizedExpression : {@link Expression} ::= <span class="component">{@link Expression}</span>;

 */
public class ParenthesizedExpression extends Expression implements Cloneable {
  /**
   * @aspect Logging
   * @declaredat C:\\Users\\imenrayan\\Desktop\\EMFeRTTC18-master\\jastadd-mquat-base\\src\\main\\jastadd\\Logging.jadd:36
   */
  protected static final org.apache.logging.log4j.Logger logger = org.apache.logging.log4j.LogManager.getLogger(ParenthesizedExpression.class);
  /**
   ...
   */
  public ParenthesizedExpression(Expression p0) {
    setChild(p0, 0);
  }
  /** @apilevel low-level 
   ...
   */
  public ParenthesizedExpression clone() throws CloneNotSupportedException {
    ParenthesizedExpression node = (ParenthesizedExpression) super.clone();
    return node;
  }
  /** @apilevel internal 
  ...
  public ParenthesizedExpression copy() {
    try {
      ParenthesizedExpression node = (ParenthesizedExpression) clone();
      node.parent = null;
      if (children != null) {
   ...
   */
  @Deprecated
  public ParenthesizedExpression fullCopy() {
   ...
   */
  public ParenthesizedExpression treeCopyNoTransform() {
    ParenthesizedExpression tree = (ParenthesizedExpression) copy();
    if (children != null) {
   ...
   */
  public ParenthesizedExpression treeCopy() {
    ParenthesizedExpression tree = (ParenthesizedExpression) copy();
    if (children != null) {
      for (int i = 0; i < children.length; ++i) {
  ...
  public double evalAsDouble() {
    double evalAsDouble_value = getExpression().evalAsDouble();
