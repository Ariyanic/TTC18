...
/**
 * @ast node
 * @declaredat C:\\Users\\imenrayan\\Desktop\\EMFeRTTC18-master\\jastadd-mquat-base\\src\\main\\jastadd\\Expression.ast:15
 * @production MultExpression : {@link BinaryExpression};

 */
public class MultExpression extends BinaryExpression implements Cloneable {
  /**
   * @aspect Logging
   * @declaredat C:\\Users\\imenrayan\\Desktop\\EMFeRTTC18-master\\jastadd-mquat-base\\src\\main\\jastadd\\Logging.jadd:33
   */
  protected static final org.apache.logging.log4j.Logger logger = org.apache.logging.log4j.LogManager.getLogger(MultExpression.class);
  /**
   ...
   */
  public MultExpression(Expression p0, Expression p1) {
    setChild(p0, 0);
    setChild(p1, 1);
  }
  /** @apilevel low-level 
   ...
   */
  public MultExpression clone() throws CloneNotSupportedException {
    MultExpression node = (MultExpression) super.clone();
    return node;
  }
  /** @apilevel internal 
   * @declaredat ASTNode:41
   */
  public MultExpression copy() {
    try {
      MultExpression node = (MultExpression) clone();
      node.parent = null;
      if (children != null) {
   ...
   */
  @Deprecated
  public MultExpression fullCopy() {
   ...
   */
  public MultExpression treeCopyNoTransform() {
    MultExpression tree = (MultExpression) copy();
    if (children != null) {
   ...
   */
  public MultExpression treeCopy() {
    MultExpression tree = (MultExpression) copy();
    if (children != null) {
      for (int i = 0; i < children.length; ++i) {
  ...
  public double evalAsDouble() {
    double evalAsDouble_value = getLeft().evalAsDouble() * getRight().evalAsDouble();
  ...
  public double evalUsing(Assignment assignment) {
    double evalUsing_Assignment_value = getLeft().evalUsing(assignment) * getRight().evalUsing(assignment);
