...
/**
 * @ast node
 * @declaredat C:\\Users\\imenrayan\\Desktop\\EMFeRTTC18-master\\jastadd-mquat-base\\src\\main\\jastadd\\Expression.ast:13
 * @production AddExpression : {@link BinaryExpression};

 */
public class AddExpression extends BinaryExpression implements Cloneable {
  /**
   * @aspect Logging
   * @declaredat C:\\Users\\imenrayan\\Desktop\\EMFeRTTC18-master\\jastadd-mquat-base\\src\\main\\jastadd\\Logging.jadd:3
   */
  protected static final org.apache.logging.log4j.Logger logger = org.apache.logging.log4j.LogManager.getLogger(AddExpression.class);
  /**
   ...
   */
  public AddExpression(Expression p0, Expression p1) {
    setChild(p0, 0);
    setChild(p1, 1);
  }
  /** @apilevel low-level 
   ...
   */
  public AddExpression clone() throws CloneNotSupportedException {
    AddExpression node = (AddExpression) super.clone();
    return node;
  }
  /** @apilevel internal 
   * @declaredat ASTNode:41
   */
  public AddExpression copy() {
    try {
      AddExpression node = (AddExpression) clone();
      node.parent = null;
      if (children != null) {
   ...
   */
  public AddExpression treeCopyNoTransform() {
    AddExpression tree = (AddExpression) copy();
    if (children != null) {
