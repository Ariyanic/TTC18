...
/**
 * @ast node
 * @declaredat C:\\Users\\imenrayan\\Desktop\\EMFeRTTC18-master\\jastadd-mquat-base\\src\\main\\jastadd\\Expression.ast:16
 * @production DivExpression : {@link BinaryExpression};

 */
public class DivExpression extends BinaryExpression implements Cloneable {
  /**
   * @aspect Logging
   * @declaredat C:\\Users\\imenrayan\\Desktop\\EMFeRTTC18-master\\jastadd-mquat-base\\src\\main\\jastadd\\Logging.jadd:12
   */
  protected static final org.apache.logging.log4j.Logger logger = org.apache.logging.log4j.LogManager.getLogger(DivExpression.class);
  /**
   ...
   */
  public DivExpression(Expression p0, Expression p1) {
    setChild(p0, 0);
    setChild(p1, 1);
  }
  /** @apilevel low-level 
   ...
   */
  public DivExpression clone() throws CloneNotSupportedException {
    DivExpression node = (DivExpression) super.clone();
    return node;
  }
  /** @apilevel internal 
   * @declaredat ASTNode:41
   */
  public DivExpression copy() {
    try {
      DivExpression node = (DivExpression) clone();
      node.parent = null;
      if (children != null) {
   ...
   */
  public DivExpression treeCopyNoTransform() {
    DivExpression tree = (DivExpression) copy();
    if (children != null) {
